...
class ApiService {
  ...
  async getCountries() {
    try {
      ...
      return [
        ...
        { country_code: 'AG', country_name: 'Antigua and Barbuda', phone_code: '+1' },
        ...
        { country_code: 'AS', country_name: 'American Samoa', phone_code: '+1' },
        ...
        { country_code: 'KN', country_name: 'Saint Kitts and Nevis', phone_code: '+1' },
        ...
        { country_code: 'KY', country_name: 'Cayman Islands', phone_code: '+1' },
        ...
        { country_code: 'MK', country_name: 'North Macedonia', phone_code: '+389' },
        ...
        { country_code: 'PN', country_name: 'Pitcairn Islands', phone_code: '+64' },
        ...
        { country_code: 'ST', country_name: 'São Tomé and Príncipe', phone_code: '+239' },
        ...
        { country_code: 'TC', country_name: 'Turks and Caicos Islands', phone_code: '+1' },
        ...
        { country_code: 'TM', country_name: 'Turkmenistan', phone_code: '+993' },
        ...
        { country_code: 'TT', country_name: 'Trinidad and Tobago', phone_code: '+1' },
        ...
        { country_code: 'VA', country_name: 'Vatican City', phone_code: '+379' },
        { country_code: 'VC', country_name: 'Saint Vincent and the Grenadines', phone_code: '+1' },
        { country_code: 'VE', country_name: 'Venezuela', phone_code: '+58' },
        { country_code: 'VG', country_name: 'British Virgin Islands', phone_code: '+1' },
        { country_code: 'VI', country_name: 'U.S. Virgin Islands', phone_code: '+1' },
        { country_code: 'VN', country_name: 'Vietnam', phone_code: '+84' },
        { country_code: 'VU', country_name: 'Vanuatu', phone_code: '+678' },
        { country_code: 'WF', country_name: 'Wallis and Futuna', phone_code: '+681' },
  ...
  async getCitiesByCountry(countryCode: string) {
    ...
    try {
      ...
      const response = await axios.get(`https://goveling-api.onrender.com/geo/countries/${countryCode}/cities`);
      ...
      const staticCities: Record<string, any[]> = {
        ...
        CL: [
          { city: 'Santiago', latitude: -33.4489, longitude: -70.6693, population: 6000000, country_code: 'CL' },
          { city: 'Valparaíso', latitude: -33.0472, longitude: -71.6127, population: 300000, country_code: 'CL' },
          { city: 'Concepción', latitude: -36.8201, longitude: -73.0444, population: 230000, country_code: 'CL' },
          { city: 'La Serena', latitude: -29.9027, longitude: -71.2519, population: 200000, country_code: 'CL' },
          { city: 'Antofagasta', latitude: -23.6509, longitude: -70.3975, population: 361873, country_code: 'CL' },
          { city: 'Temuco', latitude: -38.7359, longitude: -72.5904, population: 280000, country_code: 'CL' },
          { city: 'Rancagua', latitude: -34.1708, longitude: -70.7394, population: 240000, country_code: 'CL' },
          { city: 'Arica', latitude: -18.4783, longitude: -70.3126, population: 190000, country_code: 'CL' },
          { city: 'Talca', latitude: -35.4264, longitude: -71.6554, population: 220000, country_code: 'CL' },
          { city: 'Chillán', latitude: -36.6063, longitude: -72.1033, population: 180000, country_code: 'CL' }
        ],
        MX: [
        ...
        AR: [
          { city: 'Buenos Aires', latitude: -34.6118, longitude: -58.3960, population: 3000000, country_code: 'AR' },
          { city: 'Córdoba', latitude: -31.4201, longitude: -64.1888, population: 1500000, country_code: 'AR' },
          { city: 'Rosario', latitude: -32.9442, longitude: -60.6505, population: 1200000, country_code: 'AR' },
          { city: 'Mendoza', latitude: -32.8833, longitude: -68.8167, population: 900000, country_code: 'AR' },
          { city: 'Tucumán', latitude: -26.8241, longitude: -65.2226, population: 800000, country_code: 'AR' },
          { city: 'La Plata', latitude: -34.9215, longitude: -57.9545, population: 700000, country_code: 'AR' },
          { city: 'Mar del Plata', latitude: -38.0055, longitude: -57.5426, population: 600000, country_code: 'AR' },
          { city: 'Salta', latitude: -24.7821, longitude: -65.4232, population: 500000, country_code: 'AR' },
          { city: 'Santa Fe', latitude: -31.6333, longitude: -60.7000, population: 400000, country_code: 'AR' },
          { city: 'San Juan', latitude: -31.5375, longitude: -68.5364, population: 450000, country_code: 'AR' }
        ]
      };
