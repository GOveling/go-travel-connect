export const calculateTripStatus = (trip: { startDate?: Date; endDate?: Date }): string => {
  ...
  const daysUntilStart = Math.ceil((start.getTime() - currentDate.getTime()) / (1000*60*60*24));
