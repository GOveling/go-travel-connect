...
import {
  ...
  ProfilePost,
  FriendPublication,
} from "../types/homeStateTypes";
import { initialTripsData } from "../data/mockTripsData";

export const useDataState = () => {
  const [selectedTripForPhotobook, setSelectedTripForPhotobook] =
  ...
  const [selectedPostForTrip, setSelectedPostForTrip] =
    useState<ProfilePost | null>(null);
  const [friendPublications, setFriendPublications] = useState<
    FriendPublication[]
  >([
    {
      id: "friend1-pub1",
