...
const InvitationLanding = () => {
  ...
  const [status, setStatus] = useState<
    "loading" | "valid" | "expired" | "invalid" | "accepted"
  >("loading");
  ...
  const fetchInvitationDetails = async () => {
    try {
      ...
      const { data: tripData } = await supabase
        .from("trips")
        .select(
          "id, name, destination, start_date, end_date, travelers, status, image"
        )
          ...
          <Card className="p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Esta invitación ha expirado. Contacta al organizador del viaje
        ...
        return (
          <Card className="p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Esta invitación no es válida o no existe.
              </p>
            </div>
          </Card>
        );
            ...
            <Card className="p-8 mb-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  ...
                  en la planificación de este viaje
                </p>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span>
                      {trip?.travelers} viajero
                      {(trip?.travelers || 0) > 1 ? "s" : ""}
                    </span>
                  </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-3">
                  Al hacer clic, serás redirigido a crear tu cuenta. Luego
                  podrás aceptar la invitación desde tus notificaciones.
                </p>
              </div>
            </Card>
          </>
