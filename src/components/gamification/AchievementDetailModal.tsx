      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className={`relative w-24 h-24 mx-auto rounded-full flex items-center justify-center text-4xl ${
              achievement.earned 
              ...
              <span className={achievement.earned ? 'animate-bounce' : ''}>{achievement.icon}</span>
            </div>
          ...
          {achievement.earned ? (
            <div className="space-y-4">
              ...
              {achievement.totalUsersEarned && (
                <div className="flex items-center justify-center space-x-2 text-gray-600">
                  <Users size={16} />
                  <span>{achievement.totalUsersEarned.toLocaleString()} travelers have earned this</span>
                </div>
              )}
            </div>
          ) : (
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="font-semibold text-gray-800">{achievement.progress}/{achievement.total}</span>
                </div>
              ...
              <div className="text-center bg-purple-50 rounded-lg p-4">
                <div className="flex items-center justify-center space-x-2 text-purple-600">
                  <Trophy size={16} />
                  <span className="font-semibold">Reward: {achievement.points} XP</span>
                </div>
                <p className="text-xs text-purple-500 mt-1">Complete this achievement to earn experience points</p>
              </div>
            </div>
          )}
        </div>
