    ...
    >
      <CardContent className="p-4">
        <div className="text-center space-y-3">
          ...
          <div className={`relative w-16 h-16 mx-auto rounded-full flex items-center justify-center text-2xl ${
            achievement.earned 
          ...
          {achievement.earned && achievement.totalUsersEarned && (
            <div className="flex items-center justify-center space-x-1 text-xs text-gray-500">
              <Users size={12} />
              <span>{achievement.totalUsersEarned.toLocaleString()} travelers earned this</span>
            </div>
          )}
        </div>
      </CardContent>
