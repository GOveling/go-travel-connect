...
export function ManageTeam({ tripId, isOpen, onClose, refreshData }: ManageTeamProps) {
  const { user } = useAuth();
              ...
              <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="font-medium">
                              {tripDetails.user_id === user?.id ? 'Tú' : 'Propietario'}
                            </div>
                            <div className="text-sm text-muted-foreground">
                              {tripDetails.user_id === user?.id ? user.email : ''}
                            </div>
                          </div>
                        </div>
                ...
                {userRole === 'owner' && (
                  <div className="pt-4 mt-4 border-t">
                    <h3 className="text-sm font-medium mb-3">Invitar a un nuevo miembro</h3>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-muted-foreground flex items-center gap-2">
                            ...
                            <span>
                              Expira: {format(new Date(invite.expires_at), 'dd/MM/yyyy')}
                            </span>
                          </div>
                        ...
                        <div className="text-sm text-muted-foreground flex items-center gap-2">
                          ...
                          <span>
                            {invite.status === 'accepted' ? 'Aceptada' : 'Rechazada'}: {
                              invite.accepted_at ? 
                                format(new Date(invite.accepted_at), 'dd/MM/yyyy') : 
                                format(new Date(invite.updated_at), 'dd/MM/yyyy')
                            }
                          </span>
                        </div>
                        <div className="flex gap-2 mt-1">
