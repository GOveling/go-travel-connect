  ...
  return (
    <header className="relative overflow-hidden rounded-2xl">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1 px-0">
          {subtitle || t("explore.subtitle")}
        </p>
        <div className="mt-3">
          <ButtonColorful
            label={t("explore.nearbyPlaces.exploreNow")}
      ...
      <div className="absolute -right-4 -bottom-2 w-36 h-36 select-none no-native-drag">
        <img
          src="/lovable-uploads/02afc911-6c35-4d2c-8105-91706c453843.png"
          alt="Logo dirigible — héroe"
          className="w-full h-full object-contain pointer-events-none animate-[float_6s_ease-in-out_infinite]"
          draggable={false}
