...
const ProfilePublicationModal = ({
  isOpen,
  onClose,
  onAddPublication,
}: ProfilePublicationModalProps) => {
  ...
  const handlePost = () => {
    ...
    toast({
      title: "Success",
      description: tripId
        ? "Published to your profile and added to trip!"
        ...
        <div className="space-y-4">
          {!isUsingCamera && (
            <div className="space-y-3">
              ...
              <Button
                onClick={() =>
                  document.getElementById("file-upload-publication")?.click()
                }
                variant="outline"
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  {selectedImages.length < 10 && (
                    <Button
                      onClick={() =>
                        document
                          .getElementById("file-upload-publication")
                          ?.click()
                      }
                      variant="outline"
