...
const FlightBookingHeader = ({
  currentStep,
  onStepBack,
}: FlightBookingHeaderProps) => {
  const getStepTitle = () => {
    switch (currentStep) {
      case "type":
        return "Selecciona tipo de viaje";
      case "details":
        return "Completa los detalles";
      case "summary":
        return "Confirma tu búsqueda";
      default:
        return "";
    }
  };
  ...
  return (
    <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
      <div className="flex items-center space-x-3">
        {currentStep !== "type" && (
          <Button variant="ghost" size="sm" onClick={onStepBack}>
            <ArrowLeft size={16} />
          </Button>
        )}
