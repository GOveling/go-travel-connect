...
const TripComWidget = () => {
  ...
  useEffect(() => {
    if (containerRef.current && !showIframe) {
      const container = containerRef.current;

      // Limpiar cualquier widget anterior
      container.innerHTML = "";

      // Crear el script para el widget de trip.com (adaptado del patrón de Travelpayouts)
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground text-center">
          Resultados powered by Trip.com
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ref={containerRef}
        className="w-full min-h-[400px] bg-background rounded-lg border p-4"
        style={{
          minHeight: "400px",
        }}
      />
