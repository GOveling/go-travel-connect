...
const HotelSearchModal = ({ isOpen, onClose, destination, dates, travelers }: HotelSearchModalProps) => {
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 text-white relative">
          ...
          <div className="flex items-center space-x-3 pt-2">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Encuentra tu alojamiento ideal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-green-50 p-3 rounded-lg">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-green-800">Destino: {destination}</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label htmlFor="guests" className="text-sm font-medium">Huéspedes</Label>
                <Input
                  id="guests"
                  type="number"
                  min="1"
              ...
              <div>
                <Label htmlFor="rooms" className="text-sm font-medium">Habitaciones</Label>
                <Input
                  id="rooms"
                  type="number"
                  min="1"
