...
const TransferModal = ({ isOpen, onClose, destination, transferType, fromLocation, toLocation, travelers }: TransferModalProps) => {
  const [formData, setFormData] = useState({
    from: fromLocation || (transferType === 'arrival' ? `${destination} Airport` : ''),
    to: toLocation || (transferType === 'departure' ? `${destination} Airport` : ''),
    date: '',
    time: '',
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-blue-50 p-3 rounded-lg">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-blue-800">Destino: {destination}</span>
            </div>
            <div className="text-sm text-blue-600">
              {transferType === 'arrival' && 'Transfer desde el aeropuerto a tu alojamiento'}
              {transferType === 'departure' && 'Transfer desde tu alojamiento al aeropuerto'}
          ...
          <div className="space-y-3">
            <h3 className="font-semibold text-gray-800">Opciones de Vehículo</h3>
            <div className="space-y-2">
              <div className="p-3 border rounded-lg hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-sm">Sedán Estándar</h4>
                    <p className="text-xs text-gray-600">1-3 pasajeros • Desde $25</p>
                  </div>
                  <span className="text-sm font-medium text-blue-600">Económico</span>
                </div>
              </div>
              <div className="p-3 border rounded-lg hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-600">4-8 pasajeros • Desde $45</p>
                  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label htmlFor="vehicleType" className="text-sm font-medium">Vehículo</Label>
