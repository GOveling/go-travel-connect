...
const TripMapFallback = ({ trips }: TripMapFallbackProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="p-4">
          <div className="text-center space-y-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Vista de Mapa No Disponible</h3>
              <p className="text-gray-600">Aquí tienes un resumen de tus viajes</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-600">
              {trips.reduce((total, trip) => total + (trip.coordinates?.length || 0), 0)}
            </div>
      ...
      {/* Trip List */}
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-800">Todos los Destinos</h3>
        {trips.map((trip) => (
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    {trip.isGroupTrip && (
                      <div className="flex items-center space-x-1 bg-purple-100 px-2 py-1 rounded-full">
                        ...
                        <span className="text-xs text-purple-600 font-medium">Viaje Grupal</span>
                      </div>
                    )}
                  </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="p-4">
          <div className="text-center text-blue-800">
            <p className="text-sm">
              💡 <strong>Nota:</strong> El mapa interactivo se cargará automáticamente cuando esté disponible.
              Mientras tanto, puedes ver todos los detalles de tus viajes en esta vista.
            </p>
          </div>
        </CardContent>
      </Card>
