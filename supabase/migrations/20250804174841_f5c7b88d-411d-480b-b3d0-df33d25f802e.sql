-- Migración corregida para resolver problemas de acceso post-invitación
...
-- 4. Eliminar política existente y crear nueva para trips
...
-- 5. Política para que colaboradores puedan actualizar trips
...
-- 6. Actualizar políticas para saved_places
...
DROP POLICY IF EXISTS "Collaborators can manage saved places" ON public.saved_places;
CREATE POLICY "Collaborators can manage saved places" 
...
-- 8. Políticas para trip_coordinates
